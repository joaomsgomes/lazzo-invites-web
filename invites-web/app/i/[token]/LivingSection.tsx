...
import { CameraAltIcon, IosShareIcon, PeopleIcon } from './eventActionIcons';
...
export default function LivingSection({ event, token, photos, coverPhotoId, onCoverChanged, onPhotoUploaded, onGuestsPress, onSharePress }: LivingSectionProps) {
  ...
  /** Where the upload sheet was opened from — open Manage Photos only after a successful batch. */
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: Spacing.md }}>
      ...
      <LivingActionRow
        ...
        onPhotoPress={() => setShowManagePhotos(true)}
...
function LivingActionRow({
  ...
  return (
    <div style={{ display: 'flex', gap: Spacing.sm }}>
      {/* Share */}
      <ActionButton
        icon={<IosShareIcon size={32} color={BrandColors.text1} />}
        label="Share"
      ...
      {/* Photo — opens Manage Photos (cover + add) */}
      <ActionButton
        icon={<CameraAltIcon size={32} color="#FFFFFF" />}
        label="Photo"
      ...
      {/* Guests */}
      <ActionButton
        icon={<PeopleIcon size={32} color={BrandColors.text1} />}
        label="Guests"
        backgroundColor={BrandColors.bg2}
        textColor={BrandColors.text1}
