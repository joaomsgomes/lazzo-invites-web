...
export default function Hero() {
  ...
  return (
    <section
      ...
      className="relative flex min-h-[90svh] flex-col items-center overflow-hidden px-6 pt-24 pb-8 text-center"
    >
      ...
      <a
        ...
        className="group relative z-10 inline-flex items-center justify-center px-56 py-12 sm:px-72 sm:py-14 text-xl sm:text-2xl font-bold rounded-pill transition-all duration-200 whitespace-nowrap hover:-translate-y-1 hover:scale-[1.03] shadow-[0_12px_40px_rgba(255,255,255,0.25)] hover:shadow-[0_20px_60px_rgba(255,255,255,0.4)] ring-2 ring-white/40 hover:ring-white/70"
      ...
      <a
        ...
        className="relative z-10 mt-20 flex flex-col items-center gap-2 text-text2 hover:text-text1 transition-colors"
      >
