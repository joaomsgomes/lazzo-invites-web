...
export default function StoreButtons({ location, size = 'lg' }: Props) {
  ...
  const minH = size === 'lg' ? 'min-h-[52px]' : 'min-h-11';
  const topLabel = size === 'lg' ? 'text-[11px]' : 'text-[10px]';
  const mainLabel = size === 'lg' ? 'text-base' : 'text-sm';
