...
export default function Footer() {
  return (
    <footer className="bg-bg1 border-t border-divider/40 px-6 pt-20 pb-10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-16 pt-8 border-t border-divider/40 flex flex-col items-center justify-center gap-2">
